...
int main() {
    ...
    cout << "In-order traversal of t1: " << t1.getTraversalResult() << endl;
    ...
    cout << "In-order traversal of t2: " << t2.getTraversalResult() << endl;
